...
Если Вы пытаетесь изучить Go или создаёте прототип или пишете игрушечный проект для себя, то такая разметка будет перебором. Начните с чего-то действительно простого (одиночный `main.go` файл более чем достаточно). По мере роста вашего проекта держите в голове мысль о важности хорошей структурированности кода, иначе вы получите беспорядок с множеством скрытых зависимостей и глобальным состоянием. Чем больше людей работают над проектом, тем больше нужно следить за структурированностью кода. Именно по этому важным является введение в общий подход к управлению пакетами/библиотеками.
